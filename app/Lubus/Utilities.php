...
class Utilities
{
    ...
    public static function getGreeting()
    {
        ...
        if ($time < '12') {
            echo 'Good morning';
        } elseif /* If the time is grater than or equal to 1200 hours, but less than 1700 hours, so good afternoon */ ($time >= '12' && $time < '17') {
            echo 'Good afternoon';
        } elseif /* Should the time be between or equal to 1700 and 1900 hours, show good evening */ ($time >= '17' && $time < '22') {
            echo 'Good evening';
        } elseif /* Finally, show good night if the time is greater than or equal to 2200 hours */ ($time >= '22') {
            echo 'Good night';
        }
    }
        ...
        if ($sms && $sms_status) {
            if ($gatewayStatus) {
                ...
                if (str_contains($response, 'SMS-SHOOT-ID')) {
                    ...
                    $SmsLogData = [
                        'shoot_id' => substr($response, strpos($response, 'SMS-SHOOT-ID/') + 13),
