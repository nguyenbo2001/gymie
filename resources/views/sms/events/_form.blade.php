					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								{!! Form::select('send_to[]',array('0' => 'Active members', '1' => 'Inactive members', '2' => 'Lead enquiries', '3' => 'Lost enquiries'), $send_to_data,['class'=>'form-control selectpicker show-tick show-menu-arrow','multiple' => 'multiple', 'id' => 'send_to']) !!}
							</div>
						</div>
					</div>
