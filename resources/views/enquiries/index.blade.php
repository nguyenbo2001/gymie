                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        @if($enquiry->status == 1)
                        <li>
                          <a href="{{ action('MembersController@transfer',['id' => $enquiry->id]) }}">Transfer to member</a>
                        </li>
                        @endif
                        @endpermission
                        ...
                        @if($enquiry->status == 1)
                        <li>
                          <a href="#" class="mark-enquiry-as" data-goto-url="{{ url('enquiries/'.$enquiry->id.'/markMember') }}" data-record-id="{{$enquiry->id}}">Mark as member</a>
                        </li>
                        <li>
                          <a href="#" class="mark-enquiry-as" data-goto-url="{{ url('enquiries/'.$enquiry->id.'/lost') }}" data-record-id="{{$enquiry->id}}">Mark Lost</a>
                        </li>
                        @endif
                        @endpermission
                      </ul>
