...
class SubscriptionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        $subscriptions = Subscription::indexQuery(
            ...
            ->paginate(10);
        $subscriptionTotal = Subscription::indexQuery(
            $request->sort_field,
            $request->sort_direction,
            $request->drp_start,
            $request->drp_end,
    ...
    public function expiring(Request $request)
    {
        $expirings = Subscription::expiring(
            ...
            ->search('"' . $request->input('search') . '"')
            ->paginate(10);
        $expiringTotal = Subscription::expiring(
            $request->sort_field,
            $request->sort_direction,
            $request->drp_start,
            $request->drp_end
    ...
    public function expired(Request $request)
    {
        $allExpired = Subscription::expired(
            ...
            ->search('"' . $request->input('search') . '"')
            ->paginate(10);
        $allExpiredTotal = Subscription::expired(
            $request->sort_field,
            $request->sort_direction,
            $request->drp_start,
            $request->drp_end
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            flash()->error('Error while creating the Subscription ' . $e->getMessage());
    ...
    {
        $subscription = Subscription::findOrFail($id);
        $already_paid = PaymentDetail::leftJoin(
            'cheque_details',
            'payment_details.id',
            '=',
    ...
    public function modify(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollback();
            flash()->error('Error while changing the Subscription ' . $e->getMessage());
            return back();
        }
    }
}
