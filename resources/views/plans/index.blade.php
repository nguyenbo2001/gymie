                                                            ...
                                                            <div class="btn-group">
                                                                  ...
                                                                  <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li>
                                                                              ...
                                                                              <a href="#" class="delete-record" data-dependency="{{ $dependency }}" data-dependency-message="You have members assigned to this plan, either delete them or assign them to new plan" data-delete-url="{{ url('plans/'.$plan->id.'/archive') }}" data-record-id="{{$plan->id}}">
                                                                                    Delete plan
                                                                              </a>
                                                                              @endpermission
                                                                        </li>
