...
Route::group(['prefix' => 'api', 'middleware' => ['jwt.auth']], function () {
    ...
    Route::get('expense/{id}', 'Api\ExpensesController@show');
});
...
Route::group(['prefix' => 'members', 'middleware' => ['auth']], function () {
    ...
    Route::get('create', [
        'middleware' => ['permission:manage-gymie|manage-members|add-member'],
    ...
    Route::get('{id}/edit', [
        'middleware' => ['permission:manage-gymie|manage-members|edit-member'],
    ...
    Route::post('{id}/archive', [
        'middleware' => ['permission:manage-gymie|manage-members|delete-member'],
        'uses' => 'MembersController@archive',
    ]);
    Route::get('{id}/transfer', [
        'middleware' => ['permission:manage-gymie|manage-inquiries|transfer-enquiry'],
        'uses' => 'MembersController@transfer',
    ]);
});
...
Route::group(['prefix' => 'reports', 'middleware' => ['auth']], function () {
    ...
    Route::get('members/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@gymMemberData',
    ]);
    Route::get('enquiries/charts', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@enquiryCharts',
    ]);
    Route::get('enquiries/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@enquiryData',
    ]);
    Route::get('subscriptions/charts', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@subscriptionCharts',
    ]);
    Route::get('subscriptions/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@subscriptioinData',
    ]);
    Route::get('payments/charts', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@paymentCharts',
    ]);
    Route::get('payments/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@paymentData',
    ]);
    Route::get('expenses/charts', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@expenseCharts',
    ]);
    Route::get('expenses/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@expenseData',
    ]);
    Route::get('invoices/charts', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@invoiceCharts',
    ]);
    Route::get('invoices/data', [
        'middleware' => ['permission:manage-gymie|manage-reports|view-report'],
        'uses' => 'ReportsController@invoiceData',
    ]);
});
...
Route::group(['prefix' => 'enquiries', 'middleware' => ['auth']], function () {
    ...
    Route::get('create', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|add-enquiry'],
        'uses' => 'EnquiriesController@create',
    ]);
    Route::post('/', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|add-enquiry'],
    ...
    Route::post('{id}/lost', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|view-enquiry'],
        'uses' => 'EnquiriesController@lost',
    ]);
    Route::post('{id}/markMember', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|view-enquiry'],
        'uses' => 'EnquiriesController@markMember',
    ]);
    Route::get('{id}/edit', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|edit-enquiry'],
        'uses' => 'EnquiriesController@edit',
    ]);
    Route::post('{id}/update', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|edit-enquiry'],
        'uses' => 'EnquiriesController@update',
    ]);
});
...
Route::group(['prefix' => 'enquiry', 'middleware' => ['auth']], function () {
    ...
    Route::post('followups/{id}/update', [
        'middleware' => ['permission:manage-gymie|manage-enquiries|edit-enquiry-followup'],
        'uses' => 'FollowupsController@update',
    ]);
});
...
Route::group(['prefix' => 'plans', 'middleware' => ['auth']], function () {
    ...
    Route::get('show', [
        'middleware' => ['permission:manage-gymie|manage-plans|view-plan'],
        'uses' => 'PlansController@show',
    ]);
    Route::get('create', [
        'middleware' => ['permission:manage-gymie|manage-plans|add-plan'],
    ...
    Route::get('{id}/edit', [
        'middleware' => ['permission:manage-gymie|manage-plans|edit-plan'],
    ...
    Route::post('{id}/archive', [
        'middleware' => ['permission:manage-gymie|manage-plans|delete-plan'],
        'uses' => 'PlansController@archive',
    ]);
    Route::get('/services', [
        'middleware' => ['permission:manage-gymie|manage-services|view-service'],
    ...
    Route::get('/services/create', [
        'middleware' => ['permission:manage-gymie|manage-services|add-service'],
    ...
    Route::get('/services/{id}/edit', [
        'middleware' => ['permission:manage-gymie|manage-services|edit-service'],
    ...
    Route::post('/services/{id}/delete', [
        'middleware' => ['permission:manage-gymie|manage-services|delete-service'],
