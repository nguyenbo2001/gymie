                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#" class="delete-record" data-dependency="{{ $dependency }}" data-dependency-message="You have expenses assigned to this category, either delete them or assign them to new category" data-delete-url="{{ url('expenses/categories/'.$expenseCategory->id.'/archive') }}" data-record-id="{{$expenseCategory->id}}">
                                                        Delete Category
                                                    </a>
                                                    @endpermission
                                                </li>
