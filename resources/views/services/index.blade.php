...
<div class="rightside bg-grey-100">
      ...
      <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Services
                  ...
                  <small>Details of all gym services</small></h1>
            @permission(['manage-gymie','pagehead-stats'])
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total Services</small></h1>
            @endpermission
            @endpermission
      </div><!-- / PageHead -->
                                                      ...
                                                      <td class="text-center">
                                                            <div class="btn-group">
                                                                  ...
                                                                  <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li>
                                                                              <a href="#" class="delete-record" data-dependency="{{ $dependency }}" data-dependency-message="You have plans assigned to this service, either delete them or assign them to new service" data-delete-url="{{ url('plans/services/'.$service->id.'/delete') }}" data-record-id="{{$service->id}}">
                                                                                    Delete Service
                                                                              </a>
                                                                        </li>
                                                                        @endpermission
