                                    ...
                                    <table id="triggers" class="table table-bordered table-striped">
                                          ...
                                          <tbody>
                                                ...
                                                <tr>
                                                      ...
                                                      <td class="text-center"><span class="{{ Utilities::getActiveInactive ($trigger->status) }}">{{ Utilities::getStatusValue ($trigger->status) }}</span></td>
                                                      <td class="text-center">
                                                            <div class="checkbox checkbox-theme">
                                                                  <?php $status = ($trigger->status == 1 ? 'checked="checked"' : '') ?>
                                                                  <input type="checkbox" name="triggers[]" id="trigger_{{$trigger->id}}" value="{{$trigger->id}}" {{ $status }}>
