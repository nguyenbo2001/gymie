...
<div class="rightside bg-grey-100">
      ...
      <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title">Events<small>Details of all sms events</small></h1>
                                    ...
                                    <table id="events" class="table table-bordered table-striped">
                                          ...
                                          <tbody>
                                                ...
                                                <tr>
                                                      ...
                                                      <td><span class="{{ Utilities::getActiveInactive ($event->status) }}">{{ Utilities::getStatusValue ($event->status) }}</span></td>
