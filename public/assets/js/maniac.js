	...
	return {
		...
		applyDiscount: function () {
			function getDiscountAmount() {
				...
				var admission_amount = $("#admission_amount").length ? parseInt($("#admission_amount").val()) : 0; // Get selected admission amount
				var total_amount = subscription_amount + admission_amount;
